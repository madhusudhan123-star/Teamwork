...
//             <div className='mx-4 md:mx-16 my-12 md:my-28 mb-[90vh]'>
//                 {/* First section */}
//                 <div className=''>
//                     <div className='flex flex-col mt-5 md:mt-10 gap-10 md:gap-20 items-start justify-center'>
//                         <h1 className='text-2xl md:text-4xl font-bold w-full md:w-1/2'>{data.About.maintitle}</h1>
//                         <div className='bg-black w-full h-[1px]'></div>
//                     </div>
//                     <div className='flex flex-col md:flex-row mt-5 md:mt-10 gap-5 md:gap-10 items-start justify-center'>
//                         <h2 className='text-3xl md:text-5xl font-bold w-full md:w-3/12'>{data.About.sidetitle}</h2>
//                         <p className='mt-2 md:mt-5 w-full md:w-9/12 whitespace-pre-line text-base md:text-lg'>{data.About.sidecontent}</p>
//                     </div>
//                 </div>

//                 {/* Horizontal scrolling section */}
//                 <div className='my-10 hidden md:block md:my-20 overflow-hidden' >
//                     <h1 className='text-2xl md:text-3xl mb-6 md:mb-10'>{data.About.horzientaltitle}</h1>
//                     <div
//                         className='flex overflow-x-auto gap-4 md:gap-8 pb-8 hide-scrollbar'
//                         style={{
...
//                             <div
//                                 key={index}
//                                 className=' hidden md:block advantage-card text-center w-[85vw] md:w-1/3 flex-shrink-0'
//                             >
//                                 <img className='w-full h-48 md:h-auto object-cover' src={item.image} alt={item.title} />
//                                 <h2 className='text-xl md:text-3xl font-bold my-3 md:my-5 px-3'>{item.title}</h2>
//                                 <p className='px-3 md:px-4 pb-4 text-sm md:text-base'>{item.description}</p>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
